...
function action_move(_start_delay, _delay_before_next_action, _object_id,_targetx,_targety,_steps_total){	
	
	array_push(obj_action.actions, [MOVE_OBJECT, _start_delay, _delay_before_next_action, [_object_id,_targetx,_targety,_steps_total]])
