...
//draw_text(x, y + 140, "Interstitial_isLoaded: " + string(interstitial_isLoaded));
...
draw_text(x, y + 105, "RewardedVideoAd_isLoaded: " + string(rewardedVideoAd_isLoaded) + " Loaded: #" + string(AdMob_RewardedVideo_Instances_Count()));
...
// use recorded draw text settings
draw_set_font(_temp_font);
draw_set_valign(_temp_valign);
draw_set_halign(_temp_halign);